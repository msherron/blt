#!/bin/bash
#
# Post-provisioning script to configure solr locally with Acquia Cloud config.
#
...
# `solr` in the `installed_extras`, and is currently set up for the D8 version
# of Search API Solr. Note
 
SOLR_SETUP_COMPLETE_FILE=/etc/drupal_vm_local_solr_config_complete_4
 
# Search API Solr module.
SOLR_DOWNLOAD=https://ftp.drupal.org/files/projects/search_api_solr-8.x-1.2.tar.gz
